...
def train_logistic_regression(X_train, X_test, y_train, y_test, use_saved_models, models_dir):
    """
    Trainiert oder lädt Logistic Regression
    """
...
def get_critical_employees_all_models(models, X_transformed, df,
    ...
    for model_name, model in models.items():
        ...
        try:
            ...
            # ** Spezialbehandlung für LightGBM **
...
def main():
    ...
    print("Daten laden...")
    file_path = "../data/HR_bereinigt.csv"
    ...
    # 4. Modellauswahl basierend auf den Anforderungen
    ...
    #5. Benutzerwahl abfragen
    print("\n### Schritt 5 Wählen: Gespeicherte Modelle oder neues Training ###")
    use_saved_models = get_user_choice(models_dir)

    # 6. Modelle trainieren basierend auf der Auswahl
    print("\n### Schritt 6: Modelle trainieren ###")
    ...
    # Übergabe der Daten an die Funktion
